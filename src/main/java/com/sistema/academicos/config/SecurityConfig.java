...
import com.sistema.academicos.service.UsuarioService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 .antMatchers(HttpMethod.GET, "/trabalho/home/datatables/server", "/trabalho/detalhes/**", "/trabalho/download/**").permitAll()
